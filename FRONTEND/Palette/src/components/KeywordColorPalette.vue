  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-8 transition-colors duration-300">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
      <div
        ...
        :key="palette.id"
        class="w-full rounded-2xl overflow-hidden border-2 transition overflow-x-auto"
      ...
      >
        <div class="flex h-24 sm:h-36">
          <div
            ...
            :key="ci"
            class="min-w-[63px] sm:flex-1 flex items-end justify-center pb-1 group relative cursor-pointer"
        ...
        <div class="flex px-1 pt-2 pb-1 bg-amber-50 dark:bg-gray-800 overflow-x-auto">
          <div v-for="(color, ci) in palette.colors.slice(0, colorCount)" :key="ci" class="min-w-[63px] sm:flex-1 text-center">
